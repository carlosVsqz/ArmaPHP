...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    store: function store() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/notes?token=' + localStorage.getItem("api_token"), self.note).then(function (response) {
        self.note = {
          title: '',
          content: '',
          applies_to_date: '',
  ...
  mounted: function mounted() {
    var self = this;
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/notes/create?token=' + localStorage.getItem("api_token")).then(function (response) {
