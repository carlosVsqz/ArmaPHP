...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'cropperjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'cropperjs/dist/cropper.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  plusIcon: !(function webpackMissingModule() { var e = new Error("Cannot find module '@coreui/icons'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  folderIcon: !(function webpackMissingModule() { var e = new Error("Cannot find module '@coreui/icons'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  fileIcon: !(function webpackMissingModule() { var e = new Error("Cannot find module '@coreui/icons'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  levelUpIcon: !(function webpackMissingModule() { var e = new Error("Cannot find module '@coreui/icons'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
  name: 'Media',
  data: function data() {
    return {
      rightCard: 'fileInfo',
  ...
  methods: {
    croppImage: function croppImage() {
      ...
      self.cropper.getCroppedCanvas().toBlob(function (blob) {
        ...
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/file/cropp', formData).then(function (response) {
    ...
    openCroppFileModal: function openCroppFileModal(id) {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media/file?id=' + id + '&thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        ...
        self.$nextTick(function () {
          if (self.cropper !== null) {
            ...
            self.cropper = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'cropperjs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(document.getElementById('cropp-img-img'), {
    ...
    deleteFolder: function deleteFolder() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/folder/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
    ...
    deleteFile: function deleteFile() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/file/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
        self.rightCard = 'fileInfo';
    ...
    renameOpenForm: function renameOpenForm(id, type) {
      ...
      if (type == 'folder') {
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media/folder?id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        ...
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media/file?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
          self.name = response.data.name;
    ...
    moveFolder: function moveFolder() {
      if (this.selectFolder != null) {
        var self = this;
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/folder/move', {
          id: this.elementId,
    ...
    moveFile: function moveFile() {
      if (this.selectFolder != null) {
        var self = this;
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/file/move', {
          id: this.elementId,
          folder: this.selectFolder,
    ...
    copyFile: function copyFile(id) {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media/file/copy?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
        self.rightCard = 'fileInfo';
      })["catch"](function (error) {
        console.log(error);
    ...
    renameFolder: function renameFolder() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/folder/update', {
        name: this.name,
        id: this.elementId,
        token: localStorage.getItem("api_token")
      }).then(function (response) {
    ...
    renameFile: function renameFile() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/file/update', {
        name: this.name,
        id: this.elementId,
        token: localStorage.getItem("api_token"),
        thisFolder: this.thisFolder
    ...
    handleFileUpload: function handleFileUpload(files, event) {
      ...
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/media/file/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token"), formData, {
        headers: {
    ...
    addFolder: function addFolder() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media/folder/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
      })["catch"](function (error) {
        console.log(error);
        self.$router.push({
    ...
    getFoldersAndFiles: function getFoldersAndFiles(folderId) {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/media?id=' + folderId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
