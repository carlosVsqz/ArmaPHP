...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getMenus: function getMenus() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/menu/menu?token=' + localStorage.getItem("api_token")).then(function (response) {
