  ...
  */
  ...
  methods: {
    ...
    store: function store() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/roles?token=' + localStorage.getItem("api_token"), {
        name: self.role.name
  ...
  mounted: function mounted() {
    var self = this;
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/roles/create?token=' + localStorage.getItem("api_token")).then(function (response) {
