...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    store: function store() {
      var self = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/api/mailSend/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token"), {
        email: self.email
  ...
  mounted: function mounted() {
    var self = this;
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'axios'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/api/prepareSend/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token")).then(function (response) {
